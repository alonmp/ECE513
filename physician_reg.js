...
let firstInput=document.getElementById("First_name_PH");
let lastInput=document.getElementById("Last_name_PH");
let emailInput=document.getElementById("Email_PH");
let passInput=document.getElementById("Password_PH");
let passConInput=document.getElementById("Con_Password_PH");
let submitInput=document.getElementById("Submit_PH");
let resetInput=document.getElementById("Reset_PH");
...
//Checking if password has the correct length.
    ...
    if(errorOutput.innerHTML==""){
        ...
        let txdata = {
            First_name:    $("First_name_PH").val(),
            Last_name:     $("Last_name_PH").val(),
            Email:         $("Email_PH").val(),
            password:      $("Password_PH").val(),
        };
    
        $.ajax({
            url: '/physician/create',
            method: 'POST',
            contentType: 'application/json',
            data: JSON.stringify(txdata),
            dataType: 'json'
